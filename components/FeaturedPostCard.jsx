...
const FeaturedPostCard = ({post}) => {
  ...
  return (
    ...
    <>
        ...
        <div className='shadow-lg  pb-12 h-100 rounded-lg bg-white mx-auto w-[18rem] md:w-60 my-10 mb-16 cursor-pointer' >
        <Link href={`/post/${post.slug}`}>
            ...
            <div className='p-4 '>
                <div className='flex flex-wrap mb-3 text-sm md:text-xs '>
