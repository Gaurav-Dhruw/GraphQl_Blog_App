  ...
  return (
    <>
        <div className='md:bg-white bg-gradient-to-b from-transparent to-white shadow-lg rounded-lg p-8 mb-20'>
            <div className=' overflow-hidden h-60 md:h-96 mb-8 md:mb-14 rounded-md'>
                <img src={post.featuredImage.url} className='object-center w-full h-full'/>
            </div>

            <div className='lg:px-10 pb-14'>
            
                <div className='lg:flex mb-3 text-sm md:text-base' >
                ...
                <div className='font-bold text-xl md:text-3xl mb-6 md:mb-10'>
                    {post.title}
                </div>
                <div> 
